                ...
                <td>
                    <?php 
                        ...
                        if (in_array($route['url_pattern'], $urlPatternsBDD)) : ?>
                            <button class="delete" <?php if($route['url_pattern'] === '/admin/routes'){echo 'style="background-color: grey;"';} ?> onclick="deleteRoute('<?= $route['url_pattern'] ?>')">Supprimer</button>
                    <?php else : ?>
...
<!-- SCRIPTS SRV -->
<script src="../javascripts/admin/routes.js?1"></script>